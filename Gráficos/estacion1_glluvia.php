 <!DOCTYPE html>
  <html>
  <head>
    <title>Gráfico Lluvia | Estación #1</title>
...
<div class="container-all">
  ...
  <div class="w3-bar w3-black">
    ...
    <button class="w3-bar-item w3-button tablink w3-green" onclick="openprmtr(event,'Lluvia')">Lluvia</button>
  ...
  <div id="Lluvia" class="w3-container w3-border parameter">
    <br /> 
