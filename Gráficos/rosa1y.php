...
<div class="bs-example">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            ...
            <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">DATOS EXTERNOS</a>
                    <div class="dropdown-menu">
                        <a href="windy.html" class="dropdown-item">Windy</a>
                        <a href="openweather.html" class="dropdown-item">OpenWeather</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-all">
  ...
  <div id="Viento" class="w3-container w3-border parameter">
    ...
    <ul class="dropdown-menu">
      <li><a href="estacion1_gviento.php">24 horas</a></li>
      <li><a href="rosa48h.php">48 horas</a></li>
      <li><a href="rosa30d.php">30 dias</a></li>
      <li><a href="#">Año 2019</a></li>
    </ul>
  </div>
